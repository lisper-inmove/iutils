...
class RsaUtil(object):
    PUBLIC_KEY_PATH = '/Users/xiezhaopei/rsautil-keys/public-1024.pem'
    PRIVATE_KEY_PATH = '/Users/xiezhaopei/rsautil-keys/private-1024.pem'
    ...
    def encrypt_by_public_key(self, encrypt_message):
        ...
        while encrypt_message:
            ...
            out_data = cipher.encrypt(input_data.encode("utf8"))
...
if __name__ == '__main__':
    ...
    sign = rsaUtil.sign_by_private_key(message.encode("utf8"))
    print("签名结果：>>> ")
    print(sign)
    print("验签结果：>>> ")
    print(rsaUtil.verify_by_public_key(message.encode("utf8"), sign))
